function Start-AzWebAppOwn {
    ...
    Start-AzWebApp -ResourceGroupName $ResourceGroupName -Name $Name -ErrorAction Stop

    Write-Output ('Resource "{0}" successfully started' -F $Name)
}